...
def build_evaluation_prompt(card: dict, user_answer: str) -> str:
    return (
        ...
        "Evaluate and correct the user answer based on:\n"
        ...
        "Then teach the user.\n"
        "Rules:\n"
        "- Do not decide, mention, or return any long-term learning-memory action.\n"
        ...
        "Include score, status, targetUsed, targetUsageQuality, adviceChinese, teacherResponseChinese, "
        "correctedAnswer, naturalVersion, advancedVersion, mistakes, nextAction, mainTeachingPoint, "
        "microLessonChinese, retryPromptChinese, followUpPromptChinese, and sentenceFrame.\n"
    )
